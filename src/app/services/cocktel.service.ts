...
export class CocktelService {
  ...
  getAll(){
      ...
      return this.http.get('https://www.thecocktaildb.com/api/json/v1/1/filter.php?g=Cocktail_glass')
  }
  getCategorias(){
  ...
  getListadoCategoria(categoria:any){
   ...
   return  this.http.get<any[]>(`https://www.thecocktaildb.com/api/json/v1/1/filter.php?c=${categoria}`)
